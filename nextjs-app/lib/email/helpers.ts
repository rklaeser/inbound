 ...
 * @param matchReason - Optional custom match reason (defaults based on matchType)
 */
export function caseStudyToMatchedCaseStudy(
  caseStudy: CaseStudy,
  matchType: 'industry' | 'problem' | 'mentioned' = 'mentioned',
  matchReason?: string
): MatchedCaseStudy {
  return {
    caseStudyId: caseStudy.id,
    company: caseStudy.company,
    industry: caseStudy.industry,  // Now properly typed as Industry
    url: caseStudy.url,
    matchType,
    matchReason: matchReason || (matchType === 'mentioned' ? 'Mentioned in email' : 'Default case study'),
